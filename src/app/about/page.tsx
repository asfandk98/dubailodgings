        ...
        <div className="relative z-10 max-w-container-max mx-auto w-full px-gutter py-32">
          <div className="max-w-3xl">
            ...
            <p className="max-w-2xl text-white/80 text-base sm:text-lg md:text-xl leading-relaxed">
              Dubai Lodgings is designed to make discovering and booking
              accommodation in Dubai and across the UAE simple, convenient,
              and inspiring.
            </p>
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            <div className="relative">
              ...
              <div className="absolute -bottom-6 right-4 sm:right-8 bg-white rounded-lg shadow-2xl p-5 sm:p-6 max-w-[260px]">
                ...
                <p className="text-on-surface-variant text-sm mt-1 leading-relaxed">
                  Find a stay that fits the way you want to experience the
                  city.
                </p>
              </div>
            </div>
            ...
            <div className="lg:pl-4">
              ...
              <div className="space-y-5 text-on-surface-variant text-base md:text-lg leading-relaxed">
                <p>
                  Dubai Lodgings is an accommodation platform created for
                  travelers looking to discover hotels and stays in Dubai and
                  across the UAE.
                </p>

                <p>
                  We understand that choosing where to stay is an important
                  part of every journey. Location, comfort, value, and
                  convenience all matter. Our goal is to bring these choices
                  together in one simple experience.
                </p>

                <p>
                  Whether you are visiting Dubai for a holiday, a business
                  trip, a family getaway, or simply looking for a new
                  experience, Dubai Lodgings helps you explore accommodation
                  options suited to your journey.
                </p>
              </div>
        ...
        <div className="max-w-container-max mx-auto px-gutter">
          <div className="text-center max-w-2xl mx-auto mb-14">
            ...
            <p className="text-on-surface-variant text-base md:text-lg leading-relaxed">
              Every part of Dubai Lodgings is designed with one simple idea in
              mind: making your accommodation journey easier.
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            <div>
              ...
              <p className="text-white/70 text-base md:text-lg leading-relaxed max-w-xl">
                From the energy of Downtown Dubai to the coastline, business
                districts, shopping destinations, and cultural experiences,
                the right accommodation can make all the difference.
              </p>

              <p className="text-white/70 text-base md:text-lg leading-relaxed max-w-xl mt-5">
                Explore properties in locations that help you spend less time
                worrying about where to stay and more time enjoying where you
                are.
              </p>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="bg-white/10 border border-white/10 rounded-lg p-6 md:p-8 min-h-[180px] flex flex-col justify-end">
                ...
                <p className="text-white/60 text-sm mt-2">
                  Be close to Dubai&apos;s vibrant urban experiences.
                </p>
              </div>

              <div className="bg-white/10 border border-white/10 rounded-lg p-6 md:p-8 min-h-[180px] flex flex-col justify-end mt-8">
                <span className="material-symbols-outlined text-secondary text-[38px] mb-auto">
                  beach_access
                </span>
                ...
                <p className="text-white/60 text-sm mt-2">
                  Discover stays near Dubai&apos;s iconic coastline.
                </p>
              </div>
              ...
              <div className="bg-white/10 border border-white/10 rounded-lg p-6 md:p-8 min-h-[180px] flex flex-col justify-end">
                ...
                <p className="text-white/60 text-sm mt-2">
                  Convenient accommodation for business travelers.
                </p>
              </div>
              ...
              <div className="bg-white/10 border border-white/10 rounded-lg p-6 md:p-8 min-h-[180px] flex flex-col justify-end mt-8">
                ...
                <p className="text-white/60 text-sm mt-2">
                  Options designed around comfortable family journeys.
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="py-20 md:py-28 bg-surface-container">
        <div className="max-w-4xl mx-auto px-gutter text-center">
          ...
          <h2 className="font-display-lg-mobile md:font-display-lg text-primary text-3xl md:text-5xl leading-tight">
            “We believe finding the right place to stay should be part of the
            excitement of travelling, not a source of stress.”
          </h2>

          <p className="mt-7 text-on-surface-variant text-base md:text-lg max-w-2xl mx-auto leading-relaxed">
            That is why we are building Dubai Lodgings around simplicity,
            choice, convenience, and the experience of the traveler.
          </p>
        </div>
      </section>
      ...
      <section className="py-20 md:py-24 bg-white">
        <div className="max-w-container-max mx-auto px-gutter">
          <div className="relative overflow-hidden rounded-xl bg-gradient-to-r from-primary to-[#1d3768] px-7 sm:px-10 md:px-16 py-14 md:py-20">
            ...
            <div className="absolute -left-20 -bottom-20 w-72 h-72 rounded-full bg-white/5 blur-3xl" />
            ...
            <div className="relative z-10 max-w-3xl">
              ...
              <p className="text-white/70 text-base md:text-lg leading-relaxed max-w-2xl">
                Explore our accommodation collection and start planning your
                next Dubai experience.
              </p>
